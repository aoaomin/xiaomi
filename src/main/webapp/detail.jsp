       ...
       // 发送请求获取商品数据
        $.ajax({
            ...
            success: function(response) {
                ...
                // 更新商品名称
                $("#lastname").text($goods.name);
                $("#goods-name").text($goods.name);
                // 更新商品描述
                $("#goods-desc").text($goods.remark);
                //更新标题名称
                $("#goodstop").text($goods.name);
                //更新商品类型价格
                $("#goods-price1 span1").text($goods.price + " 元");
                $("#goods-price2 span1").text($goods.price + " 元");
                $("#goods-price3 span1").text($goods.price + " 元");
                // 更新商品价格
