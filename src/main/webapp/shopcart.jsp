...
<div id="outer">
    <header>
        ...
        <div id="personinfo">
            <div>用户zhangao <i class="glyphicon glyphicon-chevron-down"></i>
                <ul>
                    <li></li>
                </ul>
            </div>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                for(let i = 0; i < $cartList.length; i++) {
                    ...
                    let $col_name = $("<div>").addClass("col-name").text($cartList[i].goodsImages[0].name);
                    // var result=JSON.stringify($cartList[i].cardGoods);
                    // var result2=eval("("+result+")");
                    // let $col_name = $("<div>").addClass("col-name").text(result2.name);
                    let $col_price = $("<div>").addClass("col-price").text($cartList[i].goodsImages[0].price);
